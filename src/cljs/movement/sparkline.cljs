...
(defn sparkline [{:keys [canvas_id data endpoint? color type]}]
  "
  'Sparklines are small, high resolution graphics embedded in a context of words, numbers and images.'
  - Tufte

  This function takes a map which must contain the keys canvas_id and data, that hold
  the id of a HTML canvas element, and a list of data points.
  Optionally the graphic can be drawn with a red colored endpoint,
  the color of the graph can be set and the type can be set to either
  a line graph :line or a bar chart :bar.
  "
  ;todo: create gray boundary showing data variation.
...
(def graph3 {:canvas_id "example3"
             :data [9, 37, 23, 28, 44, 26, 43, 43, 24, 33, 17, 18, 35, 31, 30, 49, 32, 25, 48, 37, 45, 20, 23, 34, 37, 26, 34, 38, 37, 34, 23, 26, 34, 37, 18, 39, 33, 28, 27, 24, 22, 35, 24, 38, 50, 45, 41, 18, 34, 19, 9]
             :endpoint? true
