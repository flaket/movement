...
(defn add-standard-templates-to-user [user]
  (let [tx-data [{:db/id #db/id[:db.part/user -1] :category/name "Strength"}
                 ...
                 {:db/id #db/id[:db.part/user -7] :category/name "Locomotion"}
                 ...
                 {:db/id #db/id[:db.part/user -18] :category/name "Balance"}
                 ...
                 #_{:db/id          #db/id[:db.part/user -102]
                    :template/title "Bodyweight Strength"
                    :template/description
                                    ""
                 ...
                 #_{:db/id          #db/id[:db.part/user -106]
                    :template/title "Olympic Lifting"
                    :template/description
                                    ""
                    :template/part  [#db/id[:db.part/user]]}
                 ...
                 #_{:db/id          #db/id[:db.part/user -108]
                    :template/title "Mobility"
                    :template/description
                                    ""
                    :template/part  [#db/id[:db.part/user]]}

                 #_{:db/id          #db/id[:db.part/user -109]
                  :template/title "Natural Movement"
                  :template/description
                                  "Bodyweight movements in three parts, focusing on movement skills.
                 ...
                 #_{:db/id                    #db/id[:db.part/user -1091]
                  :part/title               "Warmup/Mobility (3 rounds)"
                  :part/category            [#db/id[:db.part/user -44]]
                  :part/number-of-movements 4
                  :part/rep                 10
                  :part/set                 3}
                 #_{:db/id                    #db/id[:db.part/user -1092]
                  :part/title               "Skill"
                  ...
                  :part/rep                 30
                  :part/set                 1}
                 #_{:db/id                    #db/id[:db.part/user -1093]
